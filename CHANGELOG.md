...
## [0.1.24](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/compare/hcl_domino_standalone_provisioner/v0.1.23...hcl_domino_standalone_provisioner/v0.1.24) (2026-07-13)


### Bug Fixes

* adding etherstub ([3952cff](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/3952cfff2cdfc0266902eb1f2cc4d911cec9356a))
* allow user to configure github runner role via secrets ([14da346](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/14da34638613d4a2575bb1558a144576e6f45c08))
* ansible deprecations ([7c0f128](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/7c0f1282a8afafcbbccc6aa82cae9a7ac5db6b26))
* ansible deprecations ([42b6e16](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/42b6e160d36c7cb2d101b9d2ea85882f771800bc))
* ansible deprecations ([a4ffd9e](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/a4ffd9e5753207d3456ba6a5949d68e6c7433ed0))
* ansible deprecations ([a80fd04](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/a80fd040897fd6168920a9397b26f2a515956488))
* ansible deprecations ([26ab98b](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/26ab98bd0ae6b8e201e5820b992aaa417af34564))
...
* enable Daos Server wide by default ([4f1c57e](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/4f1c57eddb09f28e2adffc953e49707494051242))
* for Lucians Template that lacks NetworkManager ([518d6aa](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/518d6aa4d95610cacfe7308fedcef08e2f08c3af))
* haproxy fails when quick start is disabled on prod machines ([c22a533](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/c22a533091fd930d989f02a97e25ebfa2877bc0f))
* haproxy fails when quick start is disabled on prod machines ([df5c755](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/df5c7554206d80a5e83eb1b24e3915cc485dde3a))
* ignore claude fodler andu pdate submodlues ([c690ad9](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/c690ad9b05e22537bebc79388625bc906cda7a9e))
...
* removing the progress role ([949f42a](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/949f42a689d0d88b25c9d2466c6304655f04f9de))
* setting github runner to false ([9438154](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/9438154a5751dd967d5ec03b4df4d9944cdad0ce))
* submodules ([f7e8ff4](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/f7e8ff48bc7c5c2af4224259533678b1a1f46b2f))
* submodules ([6ab4e00](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/6ab4e00f25b99d88ccd325c5e31cc4f0ef625f59))
* submodules ([dc40beb](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/dc40beb3f63ee3b27c5660c208b3dec3fe80d259))
* submodules ([fe0dafb](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/fe0dafb59374280c8e139105ab43b871acfe21fd))
* submodules ([2b0c935](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/2b0c9357bafd21793bfe301d83b54dfffdf3df6c))
* submodules ([482e851](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/482e8519f96d5a7b62b27365c509236bada113ee))
* submodules ([c1efaaa](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/c1efaaacfc55bded17241eed584d529e52832381))
* submodules ([fd8f48e](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/fd8f48e62e735a30315abb77538007d5b42ab4ee))
* submodules ([b28c606](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/b28c606aabc3c0d24e3d3b456c6fc261605b1c51))
* submodules ([fffe10a](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/fffe10a6c5ab7fa2b5ca82db4b6238c83ebe7e1d))
* submodules ([32c9463](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/32c94632c20e3a40f0f7147d944dc9ab0850a15d))
* update submodules ([f746fc9](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/f746fc9846aeb32c6961591425294dade1449fd8))
...
* updating examples for restapi java version changes ([d7f7464](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/d7f746458b4e2b823a605bbd9ddda5a58af91cd7))
* updating examples for restapi java version changes ([a2f442b](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/a2f442b8ef1d2fb0f3b9e1ee6ee7afebd79ceea0))
...
* updating startcloud_roles, github runner role ([72df87b](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/72df87baa920207944eb7c5842cc5f37478616b5))
* updating submodules ([0f59096](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/0f5909624f07514a4ad7f6c30cd59cc874bcd4cb))
* updating submodules ([4693d31](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/4693d3141fc1cd88ba4dfbbeff2dc1b0cbf2bf28))
* updating submodules ([9ab0e3f](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/9ab0e3fc586adf65ab7a8ce731f1d159d65ceb9f))
* updating submodules ([a3d18a2](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/a3d18a2d774d60953cf6daa9542c2c3b41570d3b))
* updating submodules ([50bbbd9](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/50bbbd9fed617712d6828ec2c467ca0fbe804aa6))
* updating submodules ([50af638](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/50af63818833b6608693c5cc846288b8de4d08a0))
* updating submodules ([2fd5523](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/2fd5523c9df75d7d521594912e37dc1a143392c9))
* updating submodules ([bd50eea](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/bd50eea1ba2e107940c3d00e769530fe5ba717f3))
* updating submodules ([62104ee](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/62104ee1c639fe5cb27fd6c58335402ecc88f3a8))
* updating submodules ([e44c369](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/e44c3691cee01816bbb831263a014d49f2e8d2d6))
* updating submodules ([4184cb0](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/4184cb07b7652f4e3b51e9047ab26468f11ffe0a))
* updating submodules ([fe3e9c1](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/fe3e9c13ecd6b937ac795a61f0cea82d6edbbdc4))
* updating submodules ([7cbb5dc](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/7cbb5dcc50822fc8464a95ce1e86763b9dcf7daa))
...
* updating submodules for security fixes ([e7110cb](https://github.com/STARTcloud/hcl_domino_standalone_provisioner/commit/e7110cb8461f3a906ac664cb80a056a6fc898472))
